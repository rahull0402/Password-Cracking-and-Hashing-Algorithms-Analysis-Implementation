# Let's create installation and setup scripts

# Installation script for Ubuntu/Kali
...
with open('install_lab.sh', 'w') as f:
    f.write(install_script)

print("Created installation script: install_lab.sh")
print(f"Script length: {len(install_script.splitlines())} lines")