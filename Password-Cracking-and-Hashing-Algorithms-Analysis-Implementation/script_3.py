# Create Hashcat integration script
hashcat_demo = """#!/usr/bin/env python3
\"\"\"
...
with open('hashcat_demo.py', 'w') as f:
    f.write(hashcat_demo)

print("Created Hashcat demo script: hashcat_demo.py")
print(f"Script length: {len(hashcat_demo.splitlines())} lines")